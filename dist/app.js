...
(function (factory) {
  ...
  var _parseSelects = function _parseSelects(_name, _textdefault, _valueDefault, _data, _value, _text, _valueSelected) {
  ...
  var _onlyNumbersCheck = function _onlyNumbersCheck(e) {
    e = e ? e : window.event;
  ...
  var _videoYoutube = function _videoYoutube() {
  ...
  App.middleware = (function (middleware) {
    this.load = function (object, elements, fnEnded) {
      ...
      var getServices = function getServices(el) {
  ...
  App.views = (function (views) {
    ...
    var _setTemplate = function _setTemplate(tmpl, data) {
